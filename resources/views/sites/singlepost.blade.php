				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="">Blog </a> <span class="lnr lnr-arrow-right"></span> <a href=""> Blog Details Page</a></p>
						</div>	
					</div>
				</div>
			</section>
